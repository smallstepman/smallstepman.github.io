...
| `machines/vm-shared.nix` | `sops.hostPubKey`, `sops.defaultSopsFile`, `sops.age.keyFile`, `sops.age.generateKey`, secret declarations for `tailscale/auth-key`, `rbw/master-password`, and `rbw/email`. |
