...
-- local yny = wezterm.plugin.require('file:///Users/m/Projects/yeetnyoink/plugins/wezterm')
...
if scheme_colors then
  ...
  local inactive_bg = shift_hex_tones(active_bg, -2) or scheme_colors.selection_bg or active_bg
  local active_fg = (scheme_colors.brights and scheme_colors.brights[5]) or scheme_colors.selection_fg or active_fg
  local inactive_fg = (scheme_colors.brights and shift_hex_tones(scheme_colors.brights[5], -2)) or config.colors.foreground
